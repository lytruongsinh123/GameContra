...
public:
	...
	virtual bool LoadImg(const std::string path, SDL_Renderer* screen); // Load hinh anh tu file len man hinh, Virtual ?? các file khác k? th?a hàm bool LoadImg và có th? code thêm mà ko ?nh h??ng BaseOject.h
